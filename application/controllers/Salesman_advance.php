...
class Salesman_advance extends MY_Controller {
	public function __construct() {
		parent::__construct();
		$this->load_global();
		$this->load->model('salesman_advance_model', 'advance');
	}
	...
	public function new_advance() {
		...
		$this->form_validation->set_rules('salesman_id', 'Salesman Name', 'trim|required');

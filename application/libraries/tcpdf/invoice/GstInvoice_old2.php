...
class GstInvoice extends MyPDF{
    ...
    // 	print_r($store);
        ...
        $this->writeHTMLCell($w, $h, $x ='40', $y='70', $custmer_details, [
    ...
    // 	print_r($customer);
        ...
        $this->writeHTMLCell(28, $h, $x ='175', $y='70', $invoice_details, [
            'R' => ['width' => 0.1,'color' => [0,0,0]],
            'T' => ['width' => 0.1,'color' => [0,0,0]],
            'B' => ['width' => 0.1,'color' => [0,0,0]],
            ], 1, 1, true, 'J', true);
            ...
            //   print_r($q2->result());
		        ...
		        foreach ($q2->result() as $res2) {
                 ...
                 $tbl .='<tr style="" nobr="true" style="width: 100%;">';
				      ...
				      $tbl .='<td colspan="1" class="text-right" style="width: '.$colW['amount'].';font-size:12px;">'.(store_number_format($res2->total_cost-$res2->tax_amt)).'</td>';
...
// 		$tbl .= "</td>";
		...
		$tbl .='<table>
		            <tbody>';
		              ...
		              //  	$tbl .= "Net Total";
		              //  	$tbl .='</td>';
		              //  	$tbl .='<td colspan="3" class="text-right">';

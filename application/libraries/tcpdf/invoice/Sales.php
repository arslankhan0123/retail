...
class Sales extends MyPDF{
    ...
    {   
        ...
        $custmer_details .= "<br><b>".$this->CI->lang->line('tax_number')." :</b> ".$customer->tax_number;
	...
	{	
		...
		$tbl .='<table nobr="true">
		            <tbody>
		                <tr nobr="true">
		                    <td colspan="12"><div style="font-size:10px;text-align:justify;"><span style="color:rgb(65, 59, 212);font-style:italic;">'.$this->CI->lang->line("termsAndConditions").':</span><br>';

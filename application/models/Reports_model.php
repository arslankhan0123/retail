...
public function sales_cust_data($custid)
  {
  $query = $this->db->select('*')
                ->from('db_customers')
                ->where("id",$custid)
...
public function spayment_dcust_ledger_data($custid,$sdate,$edate)
  {
  $query = $this->db->select('*')
                ->from('db_cobpayments')
                ->where("customer_id",$custid)
                ->where("payment_date >=",$sdate)
                ->where("payment_date <=",$edate)
                ->get()
                ->result();
  return $query;
}
...
public function purchases_supplier_data($supid)
  {
  $query = $this->db->select('*')
                ->from('db_suppliers')
                ->where("id",$supid)
...
public function purchase_supplier_ledger_data($supid,$sdate,$edate)
  {
  $query = $this->db->select('*')
                ->from('db_purchase')
                ->where("supplier_id",$supid)
                ->where("purchase_date >=",$sdate)
                ->where("purchase_date <=",$edate)
                ->get()
                ->result();
  return $query;
}

public function ppayment_supplier_ledger_data($supid,$sdate,$edate)
  {
  $query = $this->db->select('*')
                ->from('db_sobpayments')
                ->where("supplier_id",$supid)
...
public function voucher_supplier_ledger_data($supid,$sdate,$edate)
  {
  $query = $this->db->select('*')

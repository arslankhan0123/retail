...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?=$page_title;?>
        <small>View/Search Items Department</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <div class="box-tools">
                <a class="btn btn-block btn-info" href="<?php echo $base_url; ?>Bscategory/add">
                <i class="fa fa-plus"></i> Add Sub Bin</a>
              </div>
              <!-- <?php } ?> -->
            </div>
            <!-- /.box-header -->
...
$(document).ready(function() {
 ...
 /* dom:'<"row"<"col-sm-12"<"pull-left"B><"pull-right">>> <"row margin-bottom-12"<"col-sm-12"<"pull-left"l><"pull-right"fr>>>tip',*/
      buttons: {
        ...
        "ajax": {
            "url": "<?php echo site_url('Bscategory/ajax_list')?>",
            "type": "POST",

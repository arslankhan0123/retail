...
<body class="hold-transition skin-blue sidebar-mini">
          ...
          <div class="col-md-12">
            <div class="box">
              <div class="box-header">
                ...
                <a href="javascript:void(0)" onclick="printDiv('print')" class="btn btn-primary " style="float: right; margin-left:3px; "><i class="fa fa-print"></i> Print</a>
                <a href="javascript:void(0)" id="pdfPrint" class="btn btn-primary " style="float: right; "> PDF</a>
  ...
  <script type="text/javascript">
    ...
    $('#pdfPrint').on('click', function() {
          var selectedCustomer = $('#customer_id').find(':selected').val();
          var selectedStartDate = $('#from_date').val();
          var selectedEndDate = $('#to_date').val();

          var success = false;
          $("#loader-ajax").html('<img src="<?php echo $theme_link; ?>images/loader.gif"> generating...');
          $.ajax({
              type: "POST",
              dataType: 'json',
              url: $("#base_url").val() + "reports/pdf_customer_statement",
              data: {
            ...
            $(document).ajaxComplete(function() {
              if (success) {
                // var targetPdfUrl = 'http://alafraah.xyz/uploads/reports/customer_statement.pdf';
                var targetPdfUrl = $('#pdf_url').val();
                console.log('targetPdfUrl..', targetPdfUrl);
        ...
        //   var selectedStartDate = $('#from_date').val();
        //   var selectedEndDate = $('#to_date').val();
        //   //alert(selectedCustomer + "#" + selectedStartDate + "#" + selectedEndDate);
        //   //return false;
        //   var success = false;

                    ...
                    <table class="table table-bordered table-striped " id="" >
                      ...
                      <tbody id="tbodyid">
                        ...
                        <tr class="gradeX">
                          ...
                          <td><?php if($value->return_bit == 1){echo 'Return'; } else {echo 'Invoice'; } ?></td>
                          <td><?php if($value->return_bit == 0){ echo number_format($value->grand_total, 2); $tsa += $value->grand_total; } else{ echo '0.00'; $tsa += 0; } ?></td> 
                          <td><?php if($value->return_bit == 1){ echo number_format($value->grand_total, 2); $tsp += $value->grand_total; } else{ echo number_format($value->paid_amount, 2); $tsp += $value->paid_amount; } ?></td>

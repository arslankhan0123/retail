  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo $base_url; ?>Delivery_note/add"><?= $this->lang->line('new_deliverynote'); ?></a></li>
    ...
    $q3=$this->db->query("SELECT b.expire_date, b.sales_status, b.store_id,a.customer_name,a.mobile,a.phone,a.gstin,a.tax_number,a.email,
                           ...
                           b.`id`='$deliverynote_id' AND b.store_id=".get_current_store_id());
    ...
    $deliverynote_date=$res3->deliverynote_date;
    $expire_date=(!empty($res3->expire_date)) ? show_date($res3->expire_date) : '';
    $created_time=$res3->created_time;
    $reference_no=$res3->reference_no;
    $deliverynote_code=$res3->deliverynote_code;
    $deliverynote_status=$res3->deliverynote_status;
    $deliverynote_note=$res3->deliverynote_note;
    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-globe"></i> <?= $this->lang->line('deliverynote_invoice'); ?>
            <small class="pull-right">Date: <?php echo  show_date($deliverynote_date)." ".$created_time; ?></small>
          </h2>
        </div>
        <!-- /.col -->
      </div>
      ...
      <div class="row invoice-info">
        ...
        <!-- /.col -->
        <div class="col-sm-4 invoice-col">
          <b><?= $this->lang->line('invoice'); ?> #<?php echo  $deliverynote_code; ?></b><br>

          <?php if($sales_status=='Converted'){ ?>
            <b><?= $this->lang->line('sales_invoice'); ?> #<a title="View to Invoice" href="<?=base_url()?>sales/invoice/<?=get_sales_id_of_deliverynote($deliverynote_id)?>" ><?= get_sales_code(get_sales_id_of_deliverynote($deliverynote_id)); ?></a></b><br>
          <?php } ?>
        ...
        <div class="col-xs-12 table-responsive">
          <table class="table  records_table table-bordered">
            ...
            <tbody>
              ...
              $i=0;
              $tot_qty=0;
              $tot_deliverynote_price=0;
              $tot_tax_amt=0;
              $tot_discount_amt=0;
              $tot_total_cost=0;

              $q2=$this->db->query("SELECT a.description,c.item_name, a.deliverynote_qty,a.tax_type,
                                  a.price_per_unit, b.tax,b.tax_name,a.tax_amt,
                                  a.discount_input,a.discount_amt, a.unit_total_cost,
                                  a.total_cost 
                                  FROM 
                                  db_deliverynoteitems AS a,db_tax AS b,db_items AS c 
                                  WHERE 
                                  c.id=a.item_id AND b.id=a.tax_id AND a.deliverynote_id='$deliverynote_id'");
              foreach ($q2->result() as $res2) {
                  ...
                  echo "<td>".format_qty($res2->deliverynote_qty)."</td>";
                  echo "<td class='text-right'>".$CI->currency(($res2->price_per_unit * $res2->deliverynote_qty))."</td>";
                  ...
                  echo "</tr>";  
                  $tot_qty +=$res2->deliverynote_qty;
                  $tot_deliverynote_price +=$res2->price_per_unit;
            ...
            <tfoot class="text-right text-bold bg-gray">
              <tr>
                ...
                <td><?= $CI->currency($tot_deliverynote_price);?></td>
      ...
      <div class="row">
       <div class="col-md-6">
          ...
          <div class="row">
              <div class="col-md-12">
                 <div class="form-group">
                    <label for="deliverynote_note" class="col-sm-4 control-label" style="font-size: 17px;"><?= $this->lang->line('note'); ?></label>    
                    <div class="col-sm-8">
                       <label class="control-label  " style="font-size: 17px;">: <?=$deliverynote_note;?></label>
                    </div>
                 </div>
              </div>
           </div> 
      ...
      <div class="row no-print">
        <div class="col-xs-6">
          <?php if($CI->permissions('deliverynote_edit')) { ?>
          <?php $str2= ($pos==1)? 'pos/edit/':'Delivery_note/update/'; ?>
          <a href="<?php echo $base_url; ?><?=$str2;?><?php echo  $deliverynote_id ?>" class="btn btn-success">
        ...
        <?php } ?>
          ...
          <?php if($CI->permissions('sales_add') && $sales_status=='') { ?>
            <a href="<?php echo $base_url; ?>sales/deliverynote/<?php echo  $deliverynote_id ?>" class="btn btn-danger">
            <i class="fa  fa-undo"></i> Convert to Invoice
          </a>
          <?php }else{ ?>
            <a href="<?php echo $base_url; ?>sales/invoice/<?=get_sales_id_of_deliverynote($deliverynote_id)?>" class="btn btn-danger">
        ...
        <div class="col-xs-6 text-right">
          <a href="<?php echo $base_url; ?>Delivery_note/print_invoice/<?php echo  $deliverynote_id ?>" target="_blank" class="btn btn-warning">
            <i class="fa fa-print"></i> 
          Print
        </a>
        
        <a href="<?php echo $base_url; ?>Delivery_note/pdf/<?php echo  $deliverynote_id ?>" target="_blank" class="btn btn-primary">
...
<script>$(".deliverynote_list-active-li").addClass("active");</script>
</body>
</html>

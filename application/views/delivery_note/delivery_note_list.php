            ...
            <div class="box-header with-border">
              ...
              <div class="row">
                ...
                <div class="col-md-2 pull-right">
                  ...
                  <div class="box-tools">
                <a class="btn btn-block btn-info" href="<?php echo $base_url; ?>Delivery_note/add">
                <i class="fa fa-plus"></i> <?= $this->lang->line('new_deliverynote'); ?></a>
              </div>
                 <?php } ?>
                </div>
                </div>
                ...
                <!-- Warehouse Code end -->
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                       <label for="deliverynote_from_date"><?= $this->lang->line('from_date'); ?> </label></label>
                       <div class="input-group date">
                         <div class="input-group-addon">
                            <i class="fa fa-calendar"></i>
                         </div>
                         <input type="text" class="form-control pull-right datepicker"  id="deliverynote_from_date" name="deliverynote_from_date">
                      </div>
                       <span id="deliverynote_from_date_msg" style="display:none" class="text-danger"></span>
                    </div>
                  </div>

                  <div class="col-md-3">
                    <div class="form-group">
                       <label for="deliverynote_to_date"><?= $this->lang->line('to_date'); ?> </label></label>
                       <div class="input-group date">
                         <div class="input-group-addon">
                            <i class="fa fa-calendar"></i>
                         </div>
                         <input type="text" class="form-control pull-right datepicker"  id="deliverynote_to_date" name="deliverynote_to_date">
                      </div>
                       <span id="deliverynote_to_date_msg" style="display:none" class="text-danger"></span>
                    </div>
                  </div>
...
<script type="text/javascript">
      function load_datatable(){
       ...
       /* dom:'<"row"<"col-sm-12"<"pull-left"B><"pull-right">>> <"row margin-bottom-12"<"col-sm-12"<"pull-left"l><"pull-right"fr>>>tip',*/
            buttons: {
              ...
              "ajax": {
                  "url": "<?php echo site_url('Delivery_note/ajax_list')?>",
                  "type": "POST",
                  "data": {
                      warehouse_id: $("#warehouse_id").val(),
                      deliverynote_from_date: $("#deliverynote_from_date").val(),
                      deliverynote_to_date: $("#deliverynote_to_date").val(),
                      users: $("#users").val(),
                    },
      ...
      $("#warehouse_id,#deliverynote_from_date,#deliverynote_to_date,#users").on("change",function(){
...
function show_receipt(id){
  window.open("<?= base_url();?>Delivery_note/print_show_receipt/"+id, "_blank", "scrollbars=1,resizable=1,height=500,width=500");
}
</script>

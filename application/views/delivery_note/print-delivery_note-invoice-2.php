                        ...
                        <tr>
                          <td colspan="8">
                            ...
                            <span style="font-size: 25px;">
                              <b><?php echo "$deliverynote_code"; ?></b>
                            </span>
                          </td>
                        </tr>
                        <tr>
                          <td colspan="4">
                            Dated:<br>
                            <span style="font-size: 10px;">
                              <b><?php echo show_date($deliverynote_date); ?></b>
                            </span>
                          </td>
                          <td colspan="4">
                            Expire Date:<br>
...
<tbody>
 ...
 <?php
              ...
              $tot_total_cost=0;
              $tot_before_tax=0;
              /*$q2=$this->db->query("SELECT a.description,c.item_name, a.deliverynote_qty,
                                  a.price_per_unit, b.tax,b.tax_name,a.tax_amt,
                                  a.discount_input,a.discount_amt, a.unit_total_cost,
                                  a.total_cost , d.unit_name,c.hsn
                                  FROM 
                                  db_deliverynoteitems AS a,db_tax AS b,db_items AS c , db_units as d
                                  WHERE 
                                  d.id = c.unit_id and
                                  c.id=a.item_id AND b.id=a.tax_id AND a.deliverynote_id='$deliverynote_id'");*/

              $this->db->select(" a.description,c.item_name, a.deliverynote_qty,
                                  a.price_per_unit, b.tax,b.tax_name,a.tax_amt,
                                  a.discount_input,a.discount_amt, a.unit_total_cost,
                                  a.total_cost , d.unit_name,c.hsn
                              ");
              $this->db->where("a.deliverynote_id",$deliverynote_id);
              $this->db->from("db_deliverynoteitems a");
              ...
              foreach ($q2->result() as $res2) {
                  ...
                  $before_tax=$res2->unit_total_cost;// * $res2->deliverynote_qty;
                  $tot_cost_before_tax=$before_tax * $res2->deliverynote_qty;
                  ...
                  echo "<td class='text-center'>".format_qty($res2->deliverynote_qty)."</td>";
...
<tfoot>
  ...
  <tr class="bg-sky">
    ...
    <td colspan="2" class='text-right' ><b><?php echo store_number_format($tot_deliverynote_price); ?></b></td>
  ...
  <tr>
    <td colspan="16">
      <span class='amt-in-word'>
        <?= $this->lang->line('note') .":<b>". nl2br($deliverynote_note)."</b>";?>
    </span>  
    </td>
  </tr>

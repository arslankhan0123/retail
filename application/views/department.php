        ...
        <div class="content-wrapper">
          ...
          <section class="content-header">
            ...
            <ol class="breadcrumb">
              ...
              <li><a href="<?php echo $base_url; ?>Department/view">Department List</a></li>
                  ...
                  <form class="form-horizontal" id="category-form" onkeypress="return event.keyCode != 13;">
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        <label for="category" class="col-sm-2 control-label">Department Name<label class="text-danger">*</label></label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control input-sm" id="dptName" name="dptName" placeholder="" onkeyup="shift_cursor(event,'description')" value="<?php print $dptName??''; ?>" autofocus >
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <textarea type="text" class="form-control" id="dptDetails" name="dptDetails" placeholder=""><?php print $dptDetails??''; ?></textarea>

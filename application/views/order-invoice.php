...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    $q3=$this->db->query("SELECT b.store_id,a.supplier_name,a.mobile,a.phone,a.gstin,a.tax_number,a.email,
                           ...
                           a.postcode,a.address,b.order_date,b.reference_no,
                           b.order_code,b.order_status,b.order_note,
                           ...
                           b.`id`='$order_id' AND b.store_id=".get_current_store_id());
    ...
    $purchase_date=$res3->order_date;
    $reference_no=$res3->reference_no;
    $purchase_code=$res3->order_code;
    $purchase_status=$res3->order_status;
    $purchase_note=$res3->order_note;
    ...
    <section class="invoice">
      ...
      <div class="row invoice-info">
        ...
        <div class="col-sm-4 invoice-col">
          ...
          <b>Order Status :<?php echo  $purchase_status; ?></b><br>
        </div>
      </div>
        ...
        <div class="col-xs-12 table-responsive">
          <table class="table  records_table table-bordered">
            ...
            <tbody>
              ...
              $tot_total_cost=0;
              $q2=$this->db->query("SELECT a.description,c.item_name, a.order_qty,a.tax_type,
                                  a.price_per_unit, b.tax,b.tax_name,a.tax_amt,
                                  a.discount_input,a.discount_amt, a.unit_total_cost,
                                  a.total_cost 
                                  FROM 
                                  db_orderitems AS a,db_tax AS b,db_items AS c 
                                  WHERE 
                                  c.id=a.item_id AND b.id=a.tax_id AND a.order_id='$order_id'");
              foreach ($q2->result() as $res2) {
                  ...
                  echo "<td>".format_qty($res2->order_qty)."</td>";
      ...
      <div class="row no-print">
        <div class="col-xs-6">
          <?php if($CI->permissions('order_edit')) { ?>
          <a href="<?php echo $base_url; ?>orders/update/<?php echo  $order_id ?>" class="btn btn-success">
            <i class="fa  fa-edit"></i> Edit
          </a>
          <?php } ?>
        </div>
        <div class="col-xs-6 text-right">
          <a href="<?php echo $base_url; ?>orders/print_invoice/<?php echo  $order_id ?>" target="_blank" class="btn btn-warning">
              <i class="fa fa-print"></i> Print
          </a>
          <a href="<?php echo $base_url; ?>orders/pdf/<?php echo  $order_id ?>" target="_blank" class="btn btn-primary">

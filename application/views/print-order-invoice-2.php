...
<?php
    ...
    $q3=$this->db->query("SELECT a.supplier_name,a.mobile,a.phone,a.gstin,a.tax_number,a.email,
                           ...
                           a.postcode,a.address,b.order_date,b.created_time,b.reference_no,
                           b.order_code,b.order_note,b.order_status,
...
<table autosize="1" style="overflow: wrap" id='mytable' align="center" width="100%" height='100%'  cellpadding="0" cellspacing="0"  >
    <thead>
      ...
      <tr class="bg-sky">
        ...
        <th colspan='2' class="text-center">Order Price</th>
...
<tbody>
 ...
 <?php
              ...
              $this->db->select(" a.description,c.item_name, a.order_qty,a.tax_type,
                                  a.price_per_unit, b.tax,b.tax_name,a.tax_amt,
                                  a.discount_input,a.discount_amt, a.unit_total_cost,
                                  a.total_cost , d.unit_name,c.sku,c.hsn
                              ");
              $this->db->where("a.order_id",$order_id);
              $this->db->from("db_orderitems a");
              ...
              foreach ($q2->result() as $res2) {
                  ...
                  $before_tax=$res2->unit_total_cost;
                  $tot_cost_before_tax=$before_tax * $res2->order_qty;
                  ...
                  echo "<td class='text-center'>".format_qty($res2->order_qty)."</td>";
                ...
                <table style="width: 100%;" class="style_hidden fixed_table">
                     <tr>
                      <td colspan='8' style="height:80px;">
                        <span><b> Supplier Signature</b></span>
                      </td>
                      <td colspan='8'>

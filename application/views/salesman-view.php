...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?=$page_title;?>
        <small>View/Search Salesman</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo $base_url; ?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a data-toggle='tooltip' title='Do you want Import Salesman ?' href="<?php echo $base_url; ?>import/salesman"><i class="fa fa-arrow-circle-o-down "></i> <?= $this->lang->line('import_salesman'); ?></a></li>
            ...
            <div class="box-header with-border">
              <div class="col-lg-3 col-xs-6">
                ...
                <div class="checkbox icheck"><label>
                      <input type="checkbox" name="show_account_receivable" id='show_account_receivable'> <?= $this->lang->line('view_account_receivable_salesman'); ?>
                      </label>
                    </div>
                </div>
              ...
              <div class="box-tools">
                ...
                <a class="btn btn-block btn-info" href="<?php echo $base_url; ?>salesman/add">
                <i class="fa fa-plus"></i> <?= $this->lang->line('new_salesman'); ?></a>
              </div>
              <?php } ?>
            </div>
            <!-- /.box-header -->
...
function load_datatable(show_account_receivable='unchecked'){
 ...
 /* dom:'<"row"<"col-sm-12"<"pull-left"B><"pull-right">>> <"row margin-bottom-12"<"col-sm-12"<"pull-left"l><"pull-right"fr>>>tip',*/
      buttons: {
        ...
        "ajax": {
            "url": "<?php echo site_url('salesman/ajax_list')?>",
            "type": "POST",
            "data": {
...
function show_receipt(id){
  window.open("<?= base_url();?>salesman/print_show_receipt/"+id, "_blank", "scrollbars=1,resizable=1,height=500,width=500");
}

  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a data-toggle='tooltip' title='Do you want Import Salesmans ?' href="<?php echo $base_url; ?>salesmans"> <?= $this->lang->line('salesmans_list'); ?></a></li>
        <li><a data-toggle='tooltip' title='Do you want Import Salesmans ?' href="<?php echo $base_url; ?>import/salesmans"><i class="fa fa-arrow-circle-o-down "></i> <?= $this->lang->line('import_salesmans'); ?></a></li>
...
function load_datatable(show_account_receivable='unchecked'){
 ...
 /* dom:'<"row"<"col-sm-12"<"pull-left"B><"pull-right">>> <"row margin-bottom-12"<"col-sm-12"<"pull-left"l><"pull-right"fr>>>tip',*/
      buttons: {
        ...
        "ajax": {
            "url": "<?php echo site_url('salesman_advance/ajax_list')?>",
            "type": "POST",
            "data": {
...
<script src="<?php echo $theme_link; ?>js/salesman_advance/advance.js"></script>

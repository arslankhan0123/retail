                ...
                <form class="form-horizontal" id="category-form" onkeypress="return event.keyCode != 13;">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label for="department" class="col-sm-2 control-label">Department<label class="text-danger">*</label></label>
                      <div class="col-sm-4">
                    ...
                    <div class="form-group">
                      <label for="catid" class="col-sm-2 control-label">Category<label class="text-danger">*</label></label>
                      <div class="col-sm-4">
                    ...
                    <div class="form-group">
                      <label for="scatName" class="col-sm-2 control-label">Sub Category Name<label class="text-danger">*</label></label>
                      <div class="col-sm-4">
      ...
      <script type="text/javascript" >
        $(document).ready(function(){
          $('#dptid').change(function(){
            var url = "<?php echo base_url(); ?>Subcategory/get_category_data";
            var id = $('#dptid').val();
            //alert(id);alert(id2);
            $.ajax({
              method: "POST",

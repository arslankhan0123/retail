              ...
              <div class="col-md-12">
                <div class="box">
                  <div class="box-header">
                    ...
                    <a href="javascript:void(0)" onclick="printDiv('print')" class="btn btn-primary" style="float: right; margin-right: 10px;"><i class="fa fa-print"></i> Print</a>
                  </div>
                  ...
                  <div class="row" id="header" style="display: none;" >
                    ...
                    <div class="col-sm-8 col-md-8 col-xs-8" >
                      <div class="col-sm-12 col-md-12 col-12">
                        <b>Supplier&nbsp;&nbsp;:&nbsp;&nbsp;<?php echo $supplier->supplier_name; ?></b>
                      </div>
                      <div class="col-sm-12 col-md-12 col-12">
                        <b>Mobile&nbsp;&nbsp;:&nbsp;&nbsp;<?php echo $supplier->mobile; ?></b>
                      </div>
                      <div class="col-sm-12 col-md-12 col-12">
                        <b>Address&nbsp;&nbsp;:&nbsp;&nbsp;<?php echo $supplier->address; ?></b>
                      </div>
                    </div>
                  ...
                  <div class="box-body">
                    <table class="table table-bordered table-striped " id="custdata" >
                      <thead>
                        <tr class="bg-blue">
                          <th class="hidden">#</th>
                          <th data-orderable="false"><?= $this->lang->line('invoice_no'); ?></th>
                          <th data-orderable="false"><?= $this->lang->line('date'); ?></th>
                      ...
                      <tbody id="tbodyid">
                        ...
                        <tr class="gradeX">
                          ...
                          <td><?php echo number_format(($satp), 2); ?></td>
                        </tr>   
                        <?php } ?> 
                        <?php } else{ ?>
                        <?php $tsa = 0; $tsp = 0; $tsd = 0; $i = 0; ?>
                        <?php } ?>
                        ...
                        $saprod = $this->db->select("SUM(grand_total) as total,SUM(paid_amount) as ptotal")
                                          ->FROM('db_purchase')
                                          ->where('supplier_id',$supplier->id)
                                          ->where('purchase_date <=',$value->payment_date)
                                          ->get()
                                          ->row();
                        if($saprod)
                          {
                        ...
                        <tr class="gradeX">
                          ...
                          <td></td>
                          <td><?php echo number_format($value->payment, 2); $tcva += $value->payment; ?></td>
                          <td><?php echo number_format(($satp-($ptp+$tcp)), 2); ?></td>
                        </tr>   
                        <?php } ?>
                        <?php } else{ ?>
                        <?php $tcva = 0; $j = $i or $j = 0; ?>
                        <?php } ?> 
                        ...
                        <tr class="gradeX">
                          ...
                          <td><?php echo 'Payment'; ?></td>
                          <td></td>
                          <td><?php echo number_format($value->payment, 2); $tva += $value->payment; ?></td> 
                          <td><?php echo number_format(($satp-($ptp+$tcp)), 2); ?></td>
                        </tr>   
                        <?php } ?>
                        <?php } else{ ?>

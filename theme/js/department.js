...
{
	var base_url=$("#base_url").val();
	$.post(base_url+"Department/update_status",{id:id,status:status},function(result){
		if(result=="success")
				{
...
function delete_department(id)
{
   ...
   if(confirm("Do You Wants to Delete Record ?")){
   	$(".box").append('<div class="overlay"><i class="fa fa-refresh fa-spin"></i></div>');
   $.post(base_url+"Department/delete_department",{id:id},function(result){
   //alert(result);return;
	   if(result=="success")
				{
...
function multi_delete(){
    ...
    var this_id=this.id;
		...
		if(confirm("Are you sure ?")){
			...
			$.ajax({
			type: 'POST',
			url: base_url+'Department/multi_delete',
			data: data,
			cache: false,
			contentType: false,
			processData: false,
